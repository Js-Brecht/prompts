...
class TextPrompt extends Prompt {
  ...
  // }
  // this.inputHandler.setValue(v);
  // this._value = v;
  // this.fire();
  // }

  // get value() {
  //   return this.inputHandler.value;
  // }
  ...
  // get cursor() {
  //   return this.inputHandler.cursor;
  // }
  // set cursor(val) {
  //   this.inputHandler.cursor = val;
  // }
  ...
  next() {
    ...
    this.inputHandler.setValue(this.initial);
  ...
  render() {
    ...
    if (!this.inputHandler.value && this.initial) {
      this.placeholder = true;
      this.rendered = color.gray(this.transform.render(this.initial));
    } else {
      this.placeholder = false;
      this.rendered = this.transform.render(this.inputHandler.value);
    }
